...
jQuery(document).ready(function($) {
		...
		jQuery(function($) {
			...
			/* Remove Image */
			$(document).on('click','.remImage', function(event) { // defined event at the function for -> javacsript error: ReferenceError: event is not defined event.preventDefault();
			...
			/* Set featured Image */
			$(document).on('click','.setImageFeatured', function(event) {
				event.preventDefault();
				var attID = jQuery(this).attr('name');
