...
class Merlin {
	...
	protected function welcome() {
		...
		if(!function_exists('ct_get_php_memory_limit')) {
		    function ct_get_php_memory_limit() {
		        ...
		        if($memory_limit < 512) {
			        return '<span class="below-req">' . $memory_limit . '</span>';
			    } else {
			    	return '<span class="meets-req">' . $memory_limit . '</span>';
			    }
		    }
		}
	...
	protected function license() {
		...
		<div class="merlin__content--transition">
			...
			<a class="merlin__button merlin__button--knockout merlin__button--no-chevron merlin__button--external" href="https://contempothemes.com/wp-real-estate-7/docs/installation-demo-import/#4-toc-title" target="_blank">Where can I find my purchase code?</a>
