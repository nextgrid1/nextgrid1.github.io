<?php
    ...
    // add_filter('ct_need_purchase_code', '__return_false');
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Select whether or not you\'d like to display the IDX MLS compliance logo shown in the upper left of each listing overliad on the image. This is optional and only required if your MLS requests it. For use with the <a href="https://contempothemes.com/docs/ct-idx-pro/" target="_blank">CT IDX Pro</a> plugin.',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
               ...
               'subtitle' => __('These options are for use with the <a href="https://contempothemes.com/docs/ct-idx-pro/" target="_blank">CT IDX Pro</a> plugin.', 'contempo'),
               'indent' => true 
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                ...
                'type' => 'info',
                'raw' => 'You\'ve enabled Paid Submissions "Membership & Packages" that requires entering your PayPal, Stripe & Wire Transfer information into the sub menu item on the left. Please refer to the written documentation <a href="https://contempothemes.com/docs/membership-packages/" target="_blank">https://contempothemes.com/docs/membership-packages/</a>',
